<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="genkit-logo-dark.png">
    <img alt="Genkit logo" src="genkit-logo.png" width="500">
  </picture>
  <br>
...
> **Note:** This repository is the future home of Genkit Go. For now, please visit [github.com/genkit-ai/genkit/go](https://github.com/genkit-ai/genkit/tree/main/go) for source code, issues, and releases.
